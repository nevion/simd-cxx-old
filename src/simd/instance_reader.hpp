#ifndef AC_SIMD_INSTANCE_READER_HPP
#define AC_SIMD_INSTANCE_READER_HPP
...
public:
  ...
  DDS::ReturnCode_t read(TSeq& samples, DDS::SampleInfoSeq& infos) {
        ...
        if (handle_ != DDS::HANDLE_NIL)
            rv = reader_->read_instance(samples,
                                        infos,
...
#endif /* AC_SIMD_INSTANCE_READER_HPP */
