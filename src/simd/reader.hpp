...
namespace simd {
  ...
  public:
	...
	reader_->create_readcondition(DDS::NOT_READ_SAMPLE_STATE,
      ...
      ::simd::iActiveReadCondition < simd::DataReader<T>, F> ardc(rrc, simd_reader_, f);
      return ardc;
    }
