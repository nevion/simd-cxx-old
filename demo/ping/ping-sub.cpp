...
int main(int argc, char* argv[]) {
  ...
  PingTopic_t pingTopic(topic, tqos);
  ...
  simd::RDCondition rc = reader->create_readcondition();

  PingDataHandler handler;


  simd::ActiveRDCondition<simd::DataReader<PingType>&, PingDataHandler>
  ecr(rc, reader, handler);
